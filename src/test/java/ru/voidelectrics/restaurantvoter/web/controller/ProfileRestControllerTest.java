...
import static ru.voidelectrics.restaurantvoter.web.controller.ProfileRestController.REST_URL;
...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void register() throws Exception {
        UserTo newTo = new UserTo(null, "newemail@ya.ru", "newPassword");
    ...
    void update() throws Exception {
        UserTo updatedTo = new UserTo(null, "newemail@ya.ru", "newPassword");
