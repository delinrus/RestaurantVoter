...
public class RestaurantTestData {
    ...
    public static final RestaurantTo RESTAURANT_TO1 = new RestaurantTo(RESTAURANT1_ID, "Континенталь", MENU1);
    public static final RestaurantTo RESTAURANT_TO2 = new RestaurantTo(RESTAURANT1_ID + 1, "Дон помидор", MENU3);
